  ...
  public static void main(String[] args) {
    ...
    while(!stop){
     ...
     String scanned= scan.nextLine();
      switch (scanned){
        case "next":currentPage=page.next();
          unchanged=true;
          break;
        case "previous": currentPage=page.previous();
          unchanged=true;
          break;
        case "hasNext":
        ...
        case "HasPrevious":
          ...
          unchanged=false;
          break;
        case "firstPage": currentPage=page.firstPage();
          unchanged=true;
          break;
        case "lastPage": currentPage=page.lastPage();
          unchanged=true;
          break;
        case "stop": stop=true;
          break;
